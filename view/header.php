...
<head>
    ...
    <!-- Favicons-->
    <link rel="shortcut icon" href="view/img/favicon.ico" type="view/image/x-icon">
    ...
    <link rel="apple-touch-icon" type="image/x-icon" sizes="114x114" href="view/img/apple-touch-icon-114x114-precomposed.png">
    ...
    <link href="view/css/leave_review.css" rel="stylesheet">
    <link href="view/css/faq.css" rel="stylesheet">
    <link href="view/css/contact.css" rel="stylesheet">
    <link href="view/css/checkout.css" rel="stylesheet">
    <link href="view/css/cart.css" rel="stylesheet">
    <link href="view/css/blog.css" rel="stylesheet">
    <link href="view/css/account.css" rel="stylesheet">
    <link href="view/css/about.css" rel="stylesheet">
    <link href="view/css/error_track.css" rel="stylesheet">
                                    ...
                                    <div class="dropdown dropdown-access">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    <a href="help.html"><i class="ti-help-alt"></i>Sign Out</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
