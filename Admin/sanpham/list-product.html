                    ...
                    <div class="row">
                        ...
                        <div id="primary" class="content-area">
                            <main id="main" class="site-main">
                                ...
                                <section class="table-bordered">
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>100</td>
                                            <td>Chưa có ảnh</td>
                                            <td><a href=""><button type="button">Xóa</button></a> |  
                                                <a href=""><button type="button">Sửa</button></a> | 
                                                <a href=""><button type="button">Chi tiết sản phẩm</button></a></td>
                                        </tr>
                                        <tr>
                                            <tr>
                                                <td>2</td>
                                ...
                                <br>
                                <section>
                                    <a href="add-product.html"><button type="button">Thêm sản phẩm</button></a>
                                </section>
                            </main>
                            <!-- #main -->
                        </div>
