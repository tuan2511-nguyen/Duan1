                        ...
                        <nav id="primary-navigation" class="primary-navigation" aria-label="Primary Navigation" data-nav="flex-menu">
                            <ul id="menu-primary-menu" class="nav yamm">
                                <li class="sale-clr yamm-fw menu-item animate-dropdown">
                                    <a title="Super deals" href="../../index.html">Home</a>
                                </li>
                        ...
                        <main id="main" class="site-main">
                            <section class="section-product-categories">
                                <header class="section-header">
                                    <h1 class="woocommerce-products-header__title page-title">Thêm tài khoản</h1>
                                </header>
                            </section>
                            <section class="add-categories">
                                <form action="taikhoan.html" class="">
                                    <label for="">Tên đăng nhập</label><br>
                                    <input type="text" name="danhmuc" id="add-category" placeholder="Tên đăng nhập"><br><br>
                                    <label for="">Mặt khẩu</label><br>
                                    <input type="password" name="price" id="" placeholder="Mặt khẩu"><br><br>
                                    <label for="">Email</label><br>
                                    <input type="email" name="soluong" id="" placeholder="Email"><br><br>
                                    <label for="">Địa chỉ</label><br>
                                    <input type="text" name="" id="" placeholder="Địa chỉ"><br><br>
                            ...
                            <br>
                            <section>
                                <a href="list-account.html"><button type="button">Danh sách tài khoản</button></a>
                            </section>
                        </main>
                        <!-- #main -->
                    </div>
                        ...
                        <div id="techmarket_product_categories_widget-2" class="widget woocommerce widget_product_categories techmarket_widget_product_categories">
                            <ul class="product-categories category-single">
                                <li class="product_cat">
                                    ...
                                    <ul>
                                        <li style="border-bottom: 5px solid rgb(168, 168, 255);"><a href="../taikhoan/list-account.html">Quản lý tài khoản</a></li>
                                    </ul>
                                    <ul>
