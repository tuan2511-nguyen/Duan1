		...
		<div class="row">
							...
							<div class="collapse show" id="filter_1">
								<ul>
									...
									foreach ($danhmuc as $dm) {
										extract($dm);
										echo '<li>
										<label class="container_check">' . $name . '
												<input type="checkbox" name="danh_muc[]" value="' . $category_id . '">
							...
							<div class="collapse show" id="filter_2">
								<ul>
									...
									foreach ($colors as $color) {
										extract($color);
										echo '<li>
										<label class="container_check">' . $color_name . '
												<input type="checkbox" name="colors[]" value="' . $color_id . '">
												<span class="checkmark"></span>
											</label>
										</li>';
									}
							...
							<div class="collapse" id="filter_3">
								<ul>
									...
									foreach ($brands as $brand) {
										extract($brand);
										echo '<li>
										<label class="container_check">' . $brand_name . '
			...
			<div class="col-lg-9">
				<div class="row small-gutters">
					...
					foreach ($dssp as $sp) {
						extract($sp);
						$linksp = "index.php?act=ct_sanpham&id_sp=" . $product_id;
						echo '<div class="col-6 col-md-4">
							<div class="grid_item">
								...
								<div class="price_box">
									<span class="new_price">' . $discounted_price . '</span>
									<span class="old_price">' . $base_price . '</span>
								</div>
								<ul>
