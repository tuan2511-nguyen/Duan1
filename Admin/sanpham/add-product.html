        ...
        <div id="page" class="hfeed site">
                            ...
                            <nav id="primary-navigation" class="primary-navigation" aria-label="Primary Navigation" data-nav="flex-menu">
                                <ul id="menu-primary-menu" class="nav yamm">
                                    <li class="sale-clr yamm-fw menu-item animate-dropdown">
                                        <a title="Super deals" href="product-category.html">Home</a>
                                    </li>
                        ...
                        <div id="departments-menu" class="dropdown departments-menu">
                            ...
                            <ul id="menu-departments-menu" class="dropdown-menu yamm departments-menu-dropdown">
                                ...
                                <li class="yamm-tfw menu-item menu-item-has-children animate-dropdown dropdown-submenu">
                                    <a title="Computers &amp; Laptops" data-toggle="dropdown" aria-haspopup="true" href="#">Computers &#038; Laptops <span class="caret"></span></a>
                                </li>
                                <li class="yamm-tfw menu-item menu-item-has-children animate-dropdown dropdown-submenu">
                                    <a title="Cameras &amp; Photo" data-toggle="dropdown"  aria-haspopup="true" href="#">Cameras &#038; Photo <span class="caret"></span></a>
                                </li>
                                <li class="yamm-tfw menu-item menu-item-has-children animate-dropdown dropdown-submenu">
                                    <a title="Smart Phones &amp; Tablets" data-toggle="dropdown"  aria-haspopup="true" href="#">Smart Phones &#038; Tablets <span class="caret"></span></a>
                                </li>
                                <li class="yamm-tfw menu-item menu-item-has-children animate-dropdown dropdown-submenu">
                                    <a title="Video Games &amp; Consoles" data-toggle="dropdown"  aria-haspopup="true" href="#">Video Games &#038; Consoles <span class="caret"></span></a>
                                </li>
                                <li class="yamm-tfw menu-item menu-item-has-children animate-dropdown dropdown-submenu">
                                    <a title="TV &amp; Audio" data-toggle="dropdown"  aria-haspopup="true" href="#">TV &#038; Audio <span class="caret"></span></a>
                                </li>
                                <li class="yamm-tfw menu-item menu-item-has-children animate-dropdown dropdown-submenu">
                                    <a title="Car Electronic &amp; GPS" data-toggle="dropdown"  aria-haspopup="true" href="#">Car Electronic &#038; GPS <span class="caret"></span></a>
                                </li>
                                <li class="yamm-tfw menu-item menu-item-has-children animate-dropdown dropdown-submenu">
                                    <a title="Accesories" data-toggle="dropdown"  aria-haspopup="true" href="#">Accesories <span class="caret"></span></a>
                                </li>
                            ...
                            <main id="main" class="site-main">
                                <section class="section-product-categories">
                                    <header class="section-header">
                                        <h1 class="woocommerce-products-header__title page-title">Thêm sản phẩm</h1>
                                    </header>
                                </section>
                                <section class="add-categories">
                                    <form action="danhmuc.html" class="">
                                        <label for="">Tên sản phẩm</label><br>
                                        <input type="text" name="danhmuc" id="add-category" placeholder="Tên sản phẩm"><br><br>
                                        ...
                                        <textarea name="mota" id="" cols="30" rows="10" placeholder="Mô tả">Mô tả</textarea><br><br>
                                        <input type="submit" name="btn-submit" id="" value="Thêm">
                                    </form>
                                </section>
                                <br>
                                <section>
                                    <a href="list-product.html"><button type="button">Danh sách sản phẩm</button></a>
                                </section>
                            </main>
                            <!-- #main -->
                        </div>
                            ...
                            <div id="techmarket_product_categories_widget-2" class="widget woocommerce widget_product_categories techmarket_widget_product_categories">
                                <ul class="product-categories category-single">
                                    <li class="product_cat">
                                        <ul>
                                            <li><a href="../danhmuc/list-category.html">Quản lý danh mục</a></li>
                                        </ul>
                                        <ul>
                                            <li style="border-bottom: 5px solid rgb(168, 168, 255);"><a href="../sanpham/list-product.html">Quản lý sản phẩm</a></li>
                                        </ul>
                                        <ul>
                                            <li ><a href="../taikhoan/list-account.html">Quản lý tài khoản</a></li>
                                        </ul>
                                        <ul>
                                            <li><a href="../binhluan/list-comment.html">Quản lý bình luận</a></li>
                                        </ul>
                                        <ul>
                                            <li><a href="product-category.html">Quản lý voucher</a></li>
                                        </ul>
                                        <ul>
                                            <li><a href="product-category.html">Quản lý đơn hàng</a></li>
                                        </ul>
                                        <ul>
                                            <li><a href="product-category.html">Thống kê</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
            ...
            <footer class="site-footer footer-v1">
                <div class="col-full">
                    ...
                    <div class="site-info">
                        <div class="col-full">
                            <div class="copyright">Copyright &copy; 2017 <a href="../../index.html">Techmarket</a> Theme. All rights reserved.</div>
                            <!-- .copyright -->
